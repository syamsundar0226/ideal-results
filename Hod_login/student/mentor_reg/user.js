...
// slide down myDiv3 when deluser link is clicked
...
// slide down myDiv4 when managementor link is clicked
$('#managementor').click(function() {
myDiv4.slideDown();
myDiv.slideUp();
myDiv1.slideUp();
myDiv2.slideUp();
...
$('nav ul li a:not(#Adduser, #Viewuser, #edituser, #deluser, #managementor)').click(function() {
myDiv.slideUp();
myDiv1.slideUp();
myDiv2.slideUp();
myDiv3.slideUp();
