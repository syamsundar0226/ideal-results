...
if (isset($_SESSION['branch'])) {
    ...
    // Export data code using csv
        ...
        header('Content-Disposition: attachment; filename=R20_Percentage_and_GPA_Report.csv');
        ...
        if(empty($branch)) 
        {
            $query = "SELECT  htno, regulation,Year1sem1, Year1sem2, Year2sem1, Year2sem2, Year3sem1, Year3sem2, Year4sem1, Year4sem2, CGPA, Per,10th,12th_or_diploma,gmail
                ...
                WHERE regulation = 'R20' ORDER BY Htno ASC";
        }
        else
        {
            $query = "SELECT  htno, regulation,Year1sem1, Year1sem2, Year2sem1, Year2sem2, Year3sem1, Year3sem2, Year4sem1, Year4sem2, CGPA, Per,10th,12th_or_diploma,gmail
                FROM student_details
                WHERE regulation = 'R20' AND branch='$branch' ORDER BY Htno ASC";
        }        
