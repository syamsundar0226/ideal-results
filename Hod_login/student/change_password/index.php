...
<div id="popupLogIn">
  <aside>
    <div class="content">
      ...
      <p class="para">You can change your password multiple times if you can remember you'r old password.</p>
      <ul>
    ...
    <div class="forms">
      <div class="form">
        ...
        <form action="change.php" method="POST">
          <p class="username"><input type="text" name="rollnumber" placeholder="Your Username" required></p>
      ...
      <div class="sociaux">
        ...
        <p style="font-weight:300;"> If you are facing issues with changing your password or need assistance in changing your password, please contact super admin for further support.</p>
      </div>
    </div>
...
<div id="fadeGray"></div>
<!-- partial -->
  <a href="../index.php" style="position: absolute; right: 50px; top: 50px; ">
