...
<div class="jumbotron text-center"style="background-color: #4a3d3d;">
    <h1 style="color: whitesmoke;">Upload Excel(CSV) file for student Quick results</h1>
</div>
<body>
<div>
  <h2 style="color: whitesmoke; margin-bottom: 30px; margin-left: 200px;">
    <strong>Delete before upload : :   </strong>
    <form method="POST" action="delete_quick.php" style="display: inline;">
      <input type="submit" name="delete" value="Delete Table" style="background-color: brown; color: white; font-size: 16px; padding: 10px 10px; border: none; border-radius: 5px;">
    </form>
  </h2>
</div>
</body>
<div class="container">
    <form action="excel-script_quick.php" method="post" enctype="multipart/form-data">
       <div class="row">
           <div class="col-md-4">
    ...
    <div class="col-md-4 text-center">
                <a href="../../../../Help/quick results.csv" download>
