...
$sql = "SELECT DISTINCT Subname FROM student_results WHERE Batch='$batch' AND Branch='$branch' AND Year='$year' AND Sem='$sem' AND Mentor='$username' ORDER BY Subname ASC";
